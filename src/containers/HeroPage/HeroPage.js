        ...
        <Row>
          ...
          <Col lg={6}>
            <div className="hero-text">
              ...
              Incog.ly is a peer to peer video conferencing app 
              which keeps your identity anonymous. With the feel by 
              avatarifying the remote side into a character with the pow
              er of emotions and expressions.
              </p>
            </div>
          </Col>
        </Row>
